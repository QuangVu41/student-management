            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        <div class="form__text-input"><input type="text" id="teacherName" name="teacherName"></div>
                    </div>
                    <br>
                    <div class="mb-3">
                        <label for="birthday" class="form-label">Ngày sinh<span style="color: red">*</span></label>
                        <div class="form__text-input"><input type="date" id="birthday" name="birthday"></div>
                    </div>
                    <br>
                    <div class="mb-3">
                        <label for="phonenumber" class="form-label">Số điện thoại<span style="color: red">*</span></label>
                        <div class="form__text-input"><input type="text" id="phonenumber" name="phonenumber" placeholder="0123456789"></div>
                    </div>
                    <br>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email<span style="color: red">*</span></label>
                        <div class="form__text-input"><input type="email" id="email" name="email" placeholder="name@gmail.com"></div>
                    </div>
                    <br>
                    <div class="mb-3">
                        <label for="address" class="form-label">Địa chỉ<span style="color: red">*</span></label>
                        <div class="form__text-input"><input type="address" id="address" name="address" placeholder="Hà Nội"></div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="mb-3">
                        <label for="userName" class="form-label">Tên đăng nhập<span style="color: red">*</span></label>
                        <div class="form__text-input"><input type="text" id="userName" name="userName"></div>
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">Mật khẩu<span style="color: red">*</span></label>
                        <div class="form__text-input"><input type="text" id="password" name="password"></div>
                    </div>
                    <div class="mb-3">
                        <label for="teacherSubject" class="form-label">Môn học giảng dạy chính<span style="color: red">*</span></label>
                        <select name="teacherSubject" id="teacherSubject" class="form__select form__select-lv2 form-control">
                            <?php
