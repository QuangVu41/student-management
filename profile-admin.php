                            ...
                            <div class="col-12">
                                ...
                                <div class="row row-cols-1">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            <div class="col-4">
                                                <p class="account__info">Số điện thoại</p>
                                            </div>
                                            <div class="col-8">
                                ...
                                <div class="col-12">
                                    <div class="account__heading">
                                        ...
                                        <form method="post" style="display: flex; align-items: center;">
                                            ...
                                            <input type="submit" class="btn btn--primary" name="search-admin" value="Search" />
                                            <a class="btn btn--primary" href='add-admin.php'>Add</a>
                                        </form>
                                    </div>
                                    <?php
                            ...
                            <div class="col-12">
                                <div class="account__heading">
                                    ...
                                    <form method="post" style="display: flex; align-items: center;">
                                        ...
                                        <input class="btn btn--primary" type="submit" name="search-role" value="search" />
                                        <a class="btn btn--primary" href='add-role.php'>Add</a>
                                    </form>
                                </div>
                                <?php
                                require_once './model/connect.php';
                        ...
                        <div class="col-12">
                            <div class="account__heading">
                                ...
                                <form method="post" style="display: flex; align-items: center; gap: 20px;">
                                    ...
                                    <input class="btn btn--primary" type="submit" name="search-academic-stranscript" value="Search" />
                                    <a class="btn btn--primary" href='add-academic-transcript.php'>Add</a>
                                </form>
                            </div>
                            <?php
                            require_once './model/connect.php';
